...
document.getElementById('startCamera').addEventListener('click', async function() {
    ...
    try {
        ...
        const flip = false; // Cambiado a false para evitar voltear la imagen en móviles
        ...
        alert('Error al iniciar la cámara. Por favor, verifica los permisos e intenta de nuevo.');
    }
});
